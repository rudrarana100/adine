    ...
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-ghost-pill">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Adine — Outbound CRM for Agency Founders and Solo Salespeople" },
      {
        name: "description",
        content:
          "Adine is an outbound CRM built for agency founders and solo salespeople doing high-volume cold calling. Manage sessions, auto-log calls, and follow up instantly.",
      },
      { name: "author", content: "Adine" },
